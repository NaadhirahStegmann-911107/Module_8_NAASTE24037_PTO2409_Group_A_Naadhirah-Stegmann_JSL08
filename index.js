...
const branchA = new bankBranch("High Street Branch");
console.log(branchA.getBranchInfo()); // Output: High Street Branch

const branchB = new bankBranch("Side Street Branch");
console.log(branchB.getBranchInfo()); // Output: High Street Branch
